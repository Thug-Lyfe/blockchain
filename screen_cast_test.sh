...
curl http://localhost:3004/peers | json_pp
...
echo "check the blocks from NODE4, should be at index 8 if it received the blocks from NODE1:"
curl http://localhost:3004/blocks
echo "as you can see the blockchain is not at index 8 since the NODE4 is connected to the chain and has received the blocks"
